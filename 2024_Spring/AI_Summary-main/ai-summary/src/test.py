...
client = OpenAI(api_key="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")
...
print(
    get_gpt_response(
        "Do not focus on one particular section, give me a general summary with various subheading",
        """YouTube
Terms of Service
